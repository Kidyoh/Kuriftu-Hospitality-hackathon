...
import { 
  ...
  Users, CheckCircle, Award, BarChart, Globe
} from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-primary/10 to-background">
        ...
        <div className="container px-4 py-16 md:py-32 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" onClick={() => navigate('/auth')} className="gap-2 bg-primary text-primary-foreground hover:bg-primary/90">
      ...
      <div className="container px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-card p-6 rounded-lg shadow-sm border transition-all hover:shadow-md hover:border-primary/50">
      ...
      <div className="container px-4 py-16">
        <div className="bg-gradient-to-r from-primary/80 to-primary rounded-lg p-8 md:p-12 flex flex-col items-center text-center text-primary-foreground">
          ...
          <Button size="lg" onClick={() => navigate('/auth')} variant="secondary" className="gap-2">
